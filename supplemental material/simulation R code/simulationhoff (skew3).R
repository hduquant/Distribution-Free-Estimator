...
HW.sim.skew <- function(seed,n,p,m,lambphi_12.2, psi12){
  ...
  z1 <- sqrt(chis1/1)
  eta<-rchisq(n=n,df=5-1)
  z2<-sqrt((1*chis1+eta)/5)
...
phi2[1,2]=phi2[2,1]=0.5/0.8383811 #based on simulation, E(z1z2)=0.8383811
phi2[1,3]=phi2[3,1]=0.5/0.7976586  #based on simulation, E(z1)=0.7976586
phi2[2,3]=phi2[3,2]=0.5/0.9516858 #based on simulation, E(z2)=0.9516858
